...
// }
  ...
  require 'common/top.php';
      ...
      //  $qry = "select employee_id,slot_time from slot_tbl where isactive=1 and manager_id=1";
          $qry = "select slot.employee_id,user.user_firstname,user_lastname,slot.slot_time from slot_tbl slot,user_tbl user where user.user_id=slot.employee_id and user.designation='employee' and slot.isactive=1 and slot.manager_id=$name"; 
                                ...
                                <?php
                                    if (mysqli_num_rows($rs) > 0) {
                                        ...
                                        while($row = mysqli_fetch_assoc($rs)) 
                                        {
                                          	...
                                          	echo '<td> <a href="reallocate_slot.php?id='.$row["employee_id"].'"> <button style="background-color:white;"><span class="" ></span></button></a></td>';
                                              echo "<tr>";     
