        ...
        if(($.trim(response))=='inserted successfully')
          {
            //alert("mail already exist");
             window.location.href='mail_contact_employee.php';
          }
		...
		<div class="container">
			<div class="col-lg-12">
                ...
                <ul class="breadcrumb pull-right">
                    ...
                    <li><a href="login_employee.php">Login</a></li>
                </ul>
			</div>
		</div>
                            ...
                            <div class="doc">
                                ...
                                <form role="form" method="post" action="#" data-parsley-validate id="manager_reg_form">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date_of_birth" id="phone_number" placeholder="date of birth (required)" required autofocus>
                                    </div>
                                  ...
                                  <input type="text" name="designation" class="form-control" id="full_name" placeholder="Full Name (required)" required autofocus data-parsley-pattern="^[a-zA-Z\s]*$" title="only character" pattern="^[a-zA-Z\s]*$">
                                    ...
                                    <input type="date" class="form-control" name="jdate" id="phone_number" placeholder="date of birth (required)" required autofocus>
                                    </div>
